...
const AMOVIESETUP_MEDIATYPE CFMS30Video::sudPinTypesIn[] = {
  // H264
...
const UINT CFMS30Video::sudPinTypesInCount = countof(CFMS30Video::sudPinTypesIn);

// Define Output Media Types
const AMOVIESETUP_MEDIATYPE CFMS30Video::sudPinTypesOut[] = {
...
const UINT CFMS30Video::sudPinTypesOutCount = countof(CFMS30Video::sudPinTypesOut);

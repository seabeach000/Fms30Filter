...
const AMOVIESETUP_MEDIATYPE CFMS30Audio::sudPinTypesIn[] = {
  // DVD Types
...
const UINT CFMS30Audio::sudPinTypesInCount = countof(CFMS30Audio::sudPinTypesIn);

// Define Output Media Types
const AMOVIESETUP_MEDIATYPE CFMS30Audio::sudPinTypesOut[] = {
  { &MEDIATYPE_Audio, &MEDIASUBTYPE_PCM        },
  { &MEDIATYPE_Audio, &MEDIASUBTYPE_IEEE_FLOAT },
};
const UINT CFMS30Audio::sudPinTypesOutCount = countof(CFMS30Audio::sudPinTypesOut);
...
LAVAudioSampleFormat CFMS30Audio::GetBestAvailableSampleFormat(LAVAudioSampleFormat inFormat, int *bits, BOOL bNoFallback)
{

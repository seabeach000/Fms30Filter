...
const AMOVIESETUP_MEDIATYPE CFMS30MonoAudioMixer::sudPinTypesIn[] = {
...
const UINT CFMS30MonoAudioMixer::sudPinTypesInCount = countof(CFMS30MonoAudioMixer::sudPinTypesIn);

// Define Output Media Types
const AMOVIESETUP_MEDIATYPE CFMS30MonoAudioMixer::sudPinTypesOut[] = {
  { &MEDIATYPE_Audio, &MEDIASUBTYPE_PCM        },
  { &MEDIATYPE_Audio, &MEDIASUBTYPE_IEEE_FLOAT },
};
const UINT CFMS30MonoAudioMixer::sudPinTypesOutCount = countof(CFMS30MonoAudioMixer::sudPinTypesOut);
...
//
//void CFMS30Audio::CreateDVDLPCMHeader(BYTE * const pBuf, const WAVEFORMATEX * const wfex) const
//{
//  pBuf[0] = 0;
...
//HRESULT CFMS30Audio::ParseRealAudioHeader(const BYTE *extra, const size_t extralen)
//{
...
//void CFMS30Audio::UpdateVolumeStats(const BufferDetails &buffer)
//{
...
LAVAudioSampleFormat CFMS30MonoAudioMixer::GetBestAvailableSampleFormat(LAVAudioSampleFormat inFormat, int *bits, BOOL bNoFallback)
{
  ASSERT(inFormat >= 0 && inFormat < SampleFormat_Bitstream);

  LAVAudioSampleFormat outFormat = sampleFormatMapping[inFormat][0];
  outFormat = SampleFormat_32;
